...
/datum/design/nanites/metabolic_synthesis
	...
	category = list(RND_CATEGORY_NANITES_UTILITY)
...
/datum/design/nanites/regenerative
	...
	category = list(RND_CATEGORY_NANITES_MEDICAL)
...
/datum/design/nanites/nervous
	...
	category = list(RND_CATEGORY_NANITES_AUGMENTATION)
...
/datum/design/nanites/glitch
	...
	category = list(RND_CATEGORY_NANITES_DEFECTIVE)
...
/datum/design/nanites/flesh_eating
	...
	category = list(RND_CATEGORY_NANITES_WEAPONIZED)
...
/datum/design/nanites/shock
	...
	category = list(RND_CATEGORY_NANITES_SUPPRESSION)
...
/datum/design/nanites/sensor_health
	...
	category = list(RND_CATEGORY_NANITES_SENSOR)
